...
.bear-container {
	width: 100px;
	height: 100px;
	/* Анимация покачивания для примера */
	animation: sway 5s ease-in-out infinite;
}

.bear { fill: white; stroke: black; stroke-width: 12; stroke-linejoin: round; }
    /* Пример анимации: мишка подпрыгивает */
    @keyframes bounce {
      0%, 100% { transform: translateY(0); }
      50% { transform: translateY(-10px); }
    }
    .bear:hover { animation: bounce 0.6s ease-in-out infinite; }
</style>